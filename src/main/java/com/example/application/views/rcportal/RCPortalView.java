package com.example.application.views.rcportal;
...
@PageTitle("RC Portal")
@Route(value = "RCPortal", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@PermitAll
public class RCPortalView extends Div {
