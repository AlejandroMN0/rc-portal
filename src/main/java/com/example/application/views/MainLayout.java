...
import com.example.application.views.rcportal.RCPortalView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "RC Portal logo"));
        logoLayout.add(new H1("RC Portal"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("RC Portal", "la la-chart-area", RCPortalView.class), //
